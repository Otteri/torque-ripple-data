...
df3 = pd.read_csv('FEM-current-measurement-error.csv', names=colnames)
...
times3 = df3['time'].to_numpy()
torques3 = df3['torque'].to_numpy()
...
ax.set_ylabel('Torque amplitude [Nm]', fontsize=20, labelpad=10)

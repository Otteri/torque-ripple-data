...
data1 = pd.read_csv(BASE_PATH + "FEM-flux-harmonics.csv", skiprows=1, delimiter=';', names=['time', 'speed', 'torque'])
...
plt.ylim([0.01, 10**3])
plt.xlim([-100, 12000]) # 7550

# labels and ticks
ax.set_xticks(np.arange(0, 12000, step=930))
labels = np.arange(0, 500, step=6)
